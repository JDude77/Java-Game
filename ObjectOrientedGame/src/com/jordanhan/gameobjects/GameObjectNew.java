...
{    
    ...
    //Constructor
    public GameObjectNew(TileMapManager tmm)
    {
        this.tmm = tmm;
    }//End Constructor
    ...
    public boolean intersects(GameObjectNew obj)
    {
    ...
    public boolean collidesWith(GameObjectNew g)
    {
        //Value set-up
    ...
    public boolean pixelCollisionCheck(GameObjectNew other, Rectangle r1, Rectangle r2)
    {
